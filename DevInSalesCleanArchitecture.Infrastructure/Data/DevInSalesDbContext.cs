...
using DevInSalesCleanArchitecture.Infrastructure.Seeds;
using Microsoft.EntityFrameworkCore;

namespace DevInSalesCleanArchitecture.Infrastructure.Data
{
    public class DevInSalesDbContext : DbContext
    {
        public DevInSalesDbContext(DbContextOptions<DevInSalesDbContext> options) : base(options) { }
